window.addEventListener("DOMContentLoaded", () => {
      ...
      divReliquia.innerHTML = `
          <div class="reliquia-contenedor"
            ...
            <img class="reliquia-img" src="${
              reliquiaObj.ruta
            }" alt="${escapeHtml(reliquiaObj.nombre)}">
            <div class= "card-oro"> <p> <img class = "foto-oro" src= "../Cosas/image 43.png">:</img> ${costo} </p> </div>
          </div>
        `;
  ...
  function avanzar() {
    ...
    const nodoActual = sessionStorage.getItem("nodoMercado");
    if (nodoActual) {
      sessionStorage.setItem("nodoMercado", nodoActual);
    }
